...
var hobbieBox = document.createElement('div');
hobbieBox.id = 'hobbies';
hobbieBox.innerHTML = "Long romantic walks on the beach, candle light Big Mac dinners and tormenting the King.";
...
location.innerHTML = 'Honolulu, HI'
